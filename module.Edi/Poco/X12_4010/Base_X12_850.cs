...
namespace Edi.Application.Contracts.Poco.X12_4010
{
    ...
    public class Base_X12_850 : IEdiValidation<Base_X12_850>
    {
        ...
        public List<ValidationResult> ValidateEdi(Base_X12_850 model)
        {
            ...
            Base850Validation validationRules = new Base850Validation();
        ...
        public class FunctionalGroup : IEdiValidation<FunctionalGroup>
        {
            ...
            {
                List<ValidationResult> results = new List<ValidationResult>();
                FunctionalGroupValidation validationRules = new FunctionalGroupValidation();
                results.Add(validationRules.Validate(model));
                return results;
            }
        }
        ...
        public class Order : IEdiValidation<Order>
        {
            ...
            {
                List<ValidationResult> results = new List<ValidationResult>();
                OrderValidation validationRules = new OrderValidation();
                results.Add(validationRules.Validate(model));
                return results;
            }
        }
        ...
        public class OrderDetail : IEdiValidation<OrderDetail>
        {
            ...
            {
                List<ValidationResult> results = new List<ValidationResult>();
                OrderDetailValidation validationRules = new OrderDetailValidation();
                results.Add(validationRules.Validate(model));
                return results;
            }
        }
