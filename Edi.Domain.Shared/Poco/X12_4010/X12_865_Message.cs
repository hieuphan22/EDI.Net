...
namespace Edi.Domain.Shared.Poco.X12_4010
{
    ...
    /// </summary>
    [EdiMessage]
    public class X12_865_Message : X12_Transaction
    {
        #region BCA
        [EdiValue("X(2)", Path = "BCA/0", Description = "BCA01 - Transaction Set Purpose Code")]
        [EdiExtension(MinLength = 2, MaxLength = 2, Mandatory = true, EdiType = EdiType.Identifier)]
        public string TransactionSetPurposeCode { get; set; }

        [EdiValue("X(2)", Path = "BCA/1", Description = "BCA02 - Acknowledgment Type")]
        [EdiExtension(MinLength = 2, MaxLength = 2, Mandatory = true, EdiType = EdiType.Identifier)]
        public string AcknowledgmentType { get; set; }

        [EdiValue("X(22)", Path = "BCA/2", Description = "BCA03 - Purchase Order Number")]
        [EdiExtension(MinLength = 1, MaxLength = 22, Mandatory = true, EdiType = EdiType.Alphanumeric)]
        public string PurchaseOrderNumber { get; set; }

        [EdiValue("X(30)", Path = "BCA/3", Description = "BCA04 - Release Number")]
        [EdiExtension(MinLength = 1, MaxLength = 30, Mandatory = false, EdiType = EdiType.Alphanumeric)]
        public string ReleaseNumber { get; set; }

        [EdiValue("X(8)", Path = "BCA/4", Description = "BCA05 - Change Order Sequence Number")]
        ...
        [EdiValue("X(8)", Path = "BCA/5", Format = "yyyyMMdd", Description = "BCA06 - Date")]
        [EdiExtension(MinLength = 8, MaxLength = 8, Mandatory = true, EdiType = EdiType.Date)]
        public string Date { get; set; }

        [EdiValue("X(45)", Path = "BCA/6", Description = "BCA07 - Request Reference Number")]
        ...
        [EdiValue("X(30)", Path = "BCA/7", Description = "BCA08 - Contract Number")]
        [EdiExtension(MinLength = 1, MaxLength = 30, Mandatory = false, EdiType = EdiType.Alphanumeric)]
        public string ContractNumber { get; set; }

        [EdiValue("X(30)", Path = "BCA/8", Description = "BCA09 - Reference Identification")]
        [EdiExtension(MinLength = 1, MaxLength = 30, Mandatory = false, EdiType = EdiType.Alphanumeric)]
        public string ReferenceIdentification { get; set; }

        [EdiValue("X(8)", Path = "BCA/9", Format = "yyyyMMdd", Description = "BCA10 - Date")]
        [EdiExtension(MinLength = 8, MaxLength = 8, Mandatory = false, EdiType = EdiType.Date)]
        public string Date2 { get; set; }

        [EdiValue("X(8)", Path = "BCA/10", Format = "yyyyMMdd", Description = "BCA11 - Date")]
        [EdiExtension(MinLength = 8, MaxLength = 8, Mandatory = false, EdiType = EdiType.Date)]
        public string Date3 { get; set; }

        [EdiValue("X(8)", Path = "BCA/11", Format = "yyyyMMdd", Description = "BCA12 - Date")]
        [EdiExtension(MinLength = 8, MaxLength = 8, Mandatory = false, EdiType = EdiType.Date)]
        public string Date4 { get; set; }

        [EdiValue("X(2)", Path = "BCA/12", Description = "BCA13 - Purchase Order Type Code")]
        [EdiExtension(MinLength = 2, MaxLength = 2, Mandatory = true, EdiType = EdiType.Identifier)]
        public string PurchaseOrderTypeCode { get; set; }

        [EdiValue("X(2)", Path = "BCA/12", Description = "BCA13 - Security Level Code")]
        [EdiExtension(MinLength = 2, MaxLength = 2, Mandatory = true, EdiType = EdiType.Identifier)]
        public string SecurityLevelCode { get; set; }

        [EdiValue("X(2)", Path = "BCA/13", Description = "BCA14 - Transaction Type Code")]
        [EdiExtension(MinLength = 2, MaxLength = 2, Mandatory = true, EdiType = EdiType.Identifier)]
